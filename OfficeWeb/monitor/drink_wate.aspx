<%@ Page Title="数据监测" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="drink_wate.aspx.cs" Inherits="monitor_drink_wate" %>
        ...
        <div style="width: 100%; height: 100%;">
            ...
            <div style="height: 370px; width: 100%;">
                <div align="left" style="padding-left: 80px">
                    <dx:ASPxTabControl ID="ASPxTabControl1" runat="server" ActiveTabIndex="0" Theme="Office2010Blue"
                        OnTabClick="Cliked">
                        <Tabs>
                            <dx:Tab Text="用水量">
                            </dx:Tab>
...
<dx:SolidFillOptions></dx:SolidFillOptions>
                            ...
                            <seriesserializable>
                <dx:Series Name="用水量" ArgumentDataMember="时间" ValueDataMembersSerializable="总水量">
                    <viewserializable>
                ...
                <legendpointoptionsserializable>
                    <dx:PointOptions>
                            ...
                            <titles>
                        <dx:ChartTitle Text="饮水机用水" TextColor="Black" Font="Tahoma, 12pt" />
                    </titles>
...
<dx:ToolTipMousePosition></dx:ToolTipMousePosition>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Deer OfficeConnectionString %>"
                SelectCommand="SELECT * FROM [饮水机用水视图]"></asp:SqlDataSource>
        </div>
    </div>
</asp:Content>
