<%@ Page Title="数据监测" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="manager_envi.aspx.cs" Inherits="monitor_manager_envi" %>
    ...
    <div style="width: 765px; height: 470px; float: right; padding-right: 5px; background-color: #FFFFFF;">
        <div style="width: 100%; height: 100%;">
            <div style="height: 50px;">
                <div div align="left" style="font-family: 微软雅黑; line-height: 20px; font-size: 14px;">
                    当前位置>>经理办公室环境</div>
                <asp:Label ID="Label1" runat="server" Text="数据监测" ForeColor="Black" Font-Bold="True"
            ...
            <div style="height: 370px; width: 100%;">
                <div align="left" style="padding-left: 80px">
                    <dx:ASPxTabControl ID="ASPxTabControl1" runat="server" ActiveTabIndex="2" Theme="Office2010Blue"
                        OnTabClick="Cliked">
                        <Tabs>
                            <dx:Tab Text="温度">
                            </dx:Tab>
...
<dx:SolidFillOptions></dx:SolidFillOptions>
                            ...
                            <seriesserializable>
                <dx:Series Name="温度(℃)" ArgumentDataMember="时间" ValueDataMembersSerializable="温度3">
                    <viewserializable>
                ...
                <dx:Series Name="湿度(%)" ArgumentDataMember="时间" ValueDataMembersSerializable="湿度3">
                    <viewserializable>
                        <dx:SwiftPlotSeriesView>
                            <linestyle thickness="2" />
                            <linestyle thickness="2" />
                    ...
                    <legendpointoptionsserializable>
                        ...
                        <dx:Series ArgumentDataMember="时间" Name="光照度(lux)" 
                            ValueDataMembersSerializable="光照度3">
                            <viewserializable>
                                <dx:SwiftPlotSeriesView>
                                    <linestyle thickness="2" />
                                    <linestyle thickness="2" />
                ...
                <legendpointoptionsserializable>
                    <dx:PointOptions>
                            ...
                            <titles>
                        <dx:ChartTitle Text="经理室环境" TextColor="Black" Font="Tahoma, 12pt" />
                    </titles>
