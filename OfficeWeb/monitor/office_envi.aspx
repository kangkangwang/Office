<%@ Page Title="数据监测" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="office_envi.aspx.cs" Inherits="monitor_office_envi" %>
    ...
    <div style="width: 765px; height: 470px; float: right; padding-right: 5px; background-color: #FFFFFF;">
        <div style="width: 100%; height: 100%;">
            <div style="height: 50px; ">
                 <div div align="left" style="font-family: 微软雅黑; line-height: 20px; font-size: 14px;">当前位置>>公共办公室环境</div>
...
<dx:SolidFillOptions></dx:SolidFillOptions>
                ...
                <dx:Series Name="CO2(ppm)" ArgumentDataMember="时间" 
                    ...
                    <legendpointoptionsserializable>
                        ...
                        <dx:Series ArgumentDataMember="时间" Name="粉尘(千粒/升)" 
                        ValueDataMembersSerializable="粉尘">
                            <viewserializable>
                                <dx:SwiftPlotSeriesView>
                                    <linestyle thickness="2" />
                                    <linestyle thickness="2" />
                ...
                <dx:Series Name="温度1(℃)" ArgumentDataMember="时间" ValueDataMembersSerializable="温度1">
                    <viewserializable>
                        <dx:SwiftPlotSeriesView>
                            <linestyle thickness="2" />
                            <linestyle thickness="2" />
                    ...
                    <legendpointoptionsserializable>
                        ...
                        <dx:Series ArgumentDataMember="时间" Name="温度2(℃)" 
                            ValueDataMembersSerializable="温度2">
                            <viewserializable>
                                <dx:SwiftPlotSeriesView>
                                    <linestyle thickness="2" />
                                    <linestyle thickness="2" />
                        ...
                        <dx:Series ArgumentDataMember="时间" Name="湿度1(%)" 
                            ValueDataMembersSerializable="湿度1">
                            <viewserializable>
                                <dx:SwiftPlotSeriesView>
                                    <linestyle thickness="2" />
                                    <linestyle thickness="2" />
                        ...
                        <dx:Series ArgumentDataMember="时间" Name="湿度2(%)" 
                            ValueDataMembersSerializable="湿度2">
                            <viewserializable>
                                <dx:SwiftPlotSeriesView>
                                    <linestyle thickness="2" />
                                    <linestyle thickness="2" />
                        ...
                        <dx:Series ArgumentDataMember="时间" Name="光照度1(lux)" 
                            ValueDataMembersSerializable="光照度1">
                            <viewserializable>
                                <dx:SwiftPlotSeriesView>
                                    <linestyle thickness="2" />
                                    <linestyle thickness="2" />
                        ...
                        <dx:Series ArgumentDataMember="时间" Name="光照度2(lux)" 
                            ValueDataMembersSerializable="光照度2">
                            <viewserializable>
                                <dx:SwiftPlotSeriesView>
                                    <linestyle thickness="2" />
                                    <linestyle thickness="2" />
                ...
                <legendpointoptionsserializable>
                    ...
                    <titles>
                        <dx:ChartTitle Text="办公室环境" TextColor="Black" Font="Tahoma, 12pt"/>
                    </titles>
...
<dx:ToolTipMousePosition></dx:ToolTipMousePosition>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Deer OfficeConnectionString %>"
                    SelectCommand="SELECT * FROM [办公室环境视图]"></asp:SqlDataSource>
